    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                <li class="nav-item"><a href="home_barbeiro.php" style="color: #13292A;" class="nav-link px-2">Home</a></li>
                <li class="nav-item"><a href="agenda.php" style="color: #13292A;" class="nav-link px-2">Agendamentos</a></li>
                <li class="nav-item"><a href="fale.php" style="color: #13292A;" class="nav-link px-2">Fale</a></li>
                <li class="nav-item"><a href="planos.php" style="color: #13292A;" class="nav-link px-2">Planos</a></li>
            </ul>
