  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      <div class="modal-header border-bottom-0 d-flex justify-content-between">
        <h1 class="modal-title fs-5">Usuario não encontrado</h1>
        <a href="index.php?p=5">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </a>
      </div>
      <div class="modal-body py-0 d-flex justify-content-center">
        <p class="d-flex">Você errou seu e-mail</p>
      </div>
      <div class="modal-footer d-flex justify-content-center w-100 gap-2 pb-3 border-top-0">
        <a href="index.php?p=5">
        <button type="button" class="btn btn-lg btn-primary" style="background-color:#78CEBA; color: #13292A; border: none;">Logar novamente</button>
        </a>
      </div>
    </div>
  </div>
