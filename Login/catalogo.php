...
<a href="agende.php" class="text-decoration-none">
  <div class="p-md-5 mt-4 mb-4 rounded d-flex justify-content-between" style="background-color:#78CEBA; color: #13292A;">
    <img class="rounded bg-white" style="object-fit: cover;" src="../Imgs/icon.ico" alt="" width="150" height="150"></img>
    <div class="col d-flex align-items-start">
      <div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3" style="color: #13292A;">
      </div>
      <div>
        <h3 class="fs-2 text-body-emphasis text-sm-end" style="color: #13292A;">Barbearia Parchola</h3>
        <p class="text-sm-end" style="color: #13292A;">Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
